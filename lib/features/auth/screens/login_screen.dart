...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      final role = ref.read(selectedRoleProvider) ?? 'owner';
      if (_isLogin) {
  ...
  Widget build(BuildContext context) {
    final role = ref.watch(selectedRoleProvider) ?? 'owner';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${role == 'owner' ? 'Owner' : 'Customer'} ${_isLogin ? 'Login' : 'Sign Up'}'),
        leading: IconButton(
